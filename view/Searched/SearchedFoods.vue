<template>
  ...
  <div class="container my-5" v-if="searchedArr.length > 0">
    <div>
      <h3 class="h5"><i class="bi bi-square-fill square me-2"></i>美食</h3>
    </div>
    <div class="row gx-3">
            ...
            <div class="col-7">
              <div class="card-body pe-4">
                <div class="row flex-column justify-content-between">
                  <!-- 4.4 標題 -->
                  <div class="col mt-3 ">
                    <h6 class="fw-bold text-truncate">{{ item.RestaurantName }}</h6>
                  </div>
                  <!-- 4.5 美食描述 -->
                  <div class="col d-none d-sm-block">
                    <p class="activity-card-content truncate">{{ item.Description }}</p>
                  </div>
                  <!-- 4.5 美食地址 -->
                  <div class="col mb-2">
                    ...
                    flex-column">
                        <i class="bi bi-geo-alt-fill  location text-truncate">
                          <span class="text-dark fw-bold px-2">{{ item.City }}</span>
                        </i>
...
// console.log(eachPageLength.value.length);
